...
![传感器测试工装界面](sensor-test-lvgl-prototype.png)

*图：传感器测试工装 UI 界面 - 800x480 分辨率*

**界面说明：**

| 区域 | 功能 |
|------|------|
| **顶部 Header** | GS Logo + "传感器测试工装" 标题 |
| **电压选择区** | 5V / 12V / 24V 三档切换（当前选中 12V） |
| **左侧控制区** | 开始/停止测试按钮 + 状态显示面板 |
| **右侧波形区** | 传感器电压实时波形图表 |
| **底部 Footer** | 状态指示灯 + 版本信息 |
